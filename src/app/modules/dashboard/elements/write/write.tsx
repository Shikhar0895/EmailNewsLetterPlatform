...
import deleteAllMails from "@/actions/delete.all.mails";
...
const Write = () => {
  ...
  return (
    <div className="flex flex-col gap-2 p-4 w-full">
      ...
      <div className="w-full flex p-5 flex-wrap gap-6 relative" id="write">
        <div
        ...
        {open && (
          <div className="absolute flex items-center justify-center top-0 left-0 bg-[#00000028] h-screen w-full">
            <div className="w-[600px] p-5 bg-white rounded shadow relative">
              ...
              <h5 className="text-2xl">Enter you email subject</h5>
              <input
                type="text"
                name=""
                id=""
